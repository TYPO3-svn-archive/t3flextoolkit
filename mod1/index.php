...
$LANG->includeLLFile("EXT:t3flextoolkit/mod1/locallang.xml");
require_once (PATH_t3lib."class.t3lib_scbase.php");
$BE_USER->modAccess($MCONF,1);	// This checks permissions and exits if the users has no permission for entry.
	// DEFAULT initialization of a module [END]

class tx_t3flextoolkit_module1 extends  t3lib_SCbase {
	var $pageinfo;
	var $model;
	/**
	...
	function main()	{
		...
		if (($this->id && $access) || ($BE_USER->user["admin"] && $this->id )) {
			...
			$this->doc->JScode = '
				...
				</script><script  src="../../../../typo3conf/ext/t3flextoolkit/mod2/codepress/codepress.js" type="text/javascript"></script>
			';
		 	$this->doc->postCode='
				<script language="javascript" type="text/javascript">
					script_ended = 1;
		...
		//	t3lib_div::debug($this->model->currentFlexFormInfoAsArray);
			...
			// Render content:
			if ($this->model->codeType=='noflex') { 	$this->content.="please select a flexproject member"; } else {
				$this->moduleContent();
			}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3flextoolkit/mod1/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3flextoolkit/mod1/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_t3flextoolkit_module1');
$SOBE->init();
